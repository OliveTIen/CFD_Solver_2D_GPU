...
inline void JsonFileManager::getMemberValue(rapidjson::Value& obj, const char* membername, T_type& variable) {
	...
	const char* err = "Error: Unsupported type, in function JsonFileManager::getChildValue\n";
	const char* err2 = "Error: Unexisted key, in function JsonFileManager::getChildValue\n";
