...
void CIteration::iteration_host_2(real& t, real T, GPU::GPUSolver2* s) {
...
void CIteration::iteration_useGPU(real& t, real T, GPU::GPUSolver2* s) {
	update_host_ruvp_Uold(s->elementField_host.U, s->element_vruvp, s->element_U_old, s->elementField_host.num, GlobalPara::constant::gamma);
    ...
    // 非定常
        ...
        // 计算整体时间步长
        REAL dt = U2NITS::Time::calculateGlobalDt(t, T, GlobalPara::constant::gamma, GlobalPara::constant::Re, GlobalPara::constant::Pr, GlobalPara::time::CFL,
        ...
        GPU::FieldSoA::cuda_memcpy(&s->elementField_device, &s->elementField_host, cudaMemcpyHostToDevice);
...
void CIteration::update_host_ruvp_Uold(real* U[4], real* ruvp[4], real* U_old[4], integer num, real gamma) {
	/*
...
void CIteration::m_EvolveHost_2_addRK3(real& physicalTime, real maxPhysicalTime, GPU::ElementSoA& element_host, GPU::FieldSoA& elementField_host, GPU::EdgeSoA& edge_host, GPU::NodeSoA& node_host, real* element_vruvp[4]) {
    /*
    时间推进
    定常，采用局部时间推进，t、T无效
